...
; Initial values based on the initial readings & VAR
; -------------------------------------------------------
BASE_LINE     FCB   $90
BASE_BOW      FCB   $83
BASE_MID      FCB   $CA
...
; ------------------------------------------------------
SENSOR_LINE   FCB   $39                     ; Storage for guider sensor readings
SENSOR_BOW    FCB   $37                     ; Initialized to test values
SENSOR_PORT   FCB   $4A
SENSOR_MID    FCB   $39
SENSOR_STBD   FCB   $89
SENSOR_NUM    RMB   1 
...
NOT_REV_TRN    CMPA  #REV_TRN                         
                  BNE   NOT_LEFT_ALGN                
                  JSR   REV_TRN_ST                          
                  RTS                                           

NOT_STOP       CMPA  #ALL_STOP                            
                  BNE   NOT_LEFT_TRN                    
                  JSR   ALL_STOP_ST                          
                  RTS                                         

NOT_LEFT_TRN   CMPA  #LEFT_TRN                            
                  BNE   NOT_RIGHT_TRN                    
                  JSR   LEFT                                  
                  RTS                                                                                                                      

NOT_LEFT_ALGN CMPA  #LEFT_ALGN                      
                  BNE   NOT_RIGHT_ALGN               
                  JSR   LEFT_ALGN_DONE                     
                  RTS

NOT_RIGHT_TRN  CMPA  #RIGHT_TRN                        
                  BNE   NOT_REV_TRN             
                  JSR   RIGHT                                                                

NOT_RIGHT_ALGN CMPA  #RIGHT_ALGN                       
                  JSR   RIGHT_ALGN_DONE                  
                  RTS                                   
...
NO_BOW            LDAA    SENSOR_STBD                                                             
                  ADDA    STARBOARD_VAR                                                               
                  CMPA    BASE_STBD                                                               
                  BPL     Little_RIGHT_TRN                                                         
                  BMI     EXIT 

;***************************************************************************************************
Little_RIGHT_TRN LDY     #6000                                                                  
                  jsr     del_50us                                                                
                  JSR     INIT_RIGHT                                                              
...
CHECK_RIGHT_ALGN JSR     INIT_RIGHT                                                              
                  MOVB    #RIGHT_ALGN, CRNT_STATE                                                
                  BRA     EXIT                                                                                                                                                         

EXIT              RTS 

;***************************************************************************************************   
Little_LEFT_TRN  LDY     #6000                                                                 
                  jsr     del_50us                                                                
                  JSR     INIT_LEFT                                                               
...
CHECK_LEFT_ALGN  JSR     INIT_LEFT                                                               
                  MOVB    #LEFT_ALGN, CRNT_STATE                                                 
                  BRA     EXIT
...
LEFT_ALGN_DONE   MOVB    #FWD, CRNT_STATE                                                        
                  JSR     INIT_FWD                                                                
                  BRA     EXIT                                                                    
...
RIGHT_ALGN_DONE  MOVB    #FWD, CRNT_STATE                                                        
                  JSR     INIT_FWD                                                                
                  BRA     EXIT                                                                    
